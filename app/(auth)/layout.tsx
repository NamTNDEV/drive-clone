...
const AuthLayout = ({ children }: { children: React.ReactNode }) => {
    return (
        <div className="flex min-h-screen">
            <section className="hidden w-1/2 lg:flex xl:w-2/5 bg-brand p-10 justify-center items-center">
                <div className="flex flex-col space-y-12 max-h-[800px] max-w-[430px]">
                    <Image
